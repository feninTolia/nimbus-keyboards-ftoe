      ...
      <FadeIn>
        ...
        >
          {slice.primary.switches.map((item) => {
            return isFilled.contentRelationship(item.switch) ? (
      ...
      >
        <svg className="pointer-events-none h-auto w-full" viewBox="0 0 75 100">
          <text
            ...
            textAnchor="middle"
            fontSize={18}
            className="font-black-slanted fill-white/30 uppercase mix-blend-overlay group-hover:fill-white/60 motion-safe:transition-all motion-safe:duration-200"
          >
